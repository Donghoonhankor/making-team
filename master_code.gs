...
function buildSimilarProblemsPrompt_(studentName, examName, wrongProblems, reportText, rulesByType, planItems) {
  ...
  return [
    ...
    '- 이차함수/함수 템플릿: parabola_basic_shape, parabola_xintercepts_vertex_triangle, parabola_xintercepts_yintercept_triangle, parabola_yintercept_vertex_xintercept_triangle, parabola_band_area, parabola_family_origin, multiple_choice_parabola_position, parabola_shift_from_base, two_parabolas_same_width_horizontal_chord, two_origin_parabolas_horizontal_line, two_origin_parabolas_vertical_line_ratio, two_origin_parabolas_parallelogram, parabola_diamond_on_axes, two_parabolas_between_area, two_parabolas_square, two_parabolas_shared_vertex_intersections, line_to_parabola_quadrant_match.',
    '- 일차함수/일차방정식 템플릿: linear_basic_intercepts, linear_point_guides, linear_axis_triangle, linear_two_lines_region, linear_square_under_line, linear_parallel_lines, multiple_choice_linear_position. equation/equations에는 실제 y=... 또는 ax+by+c=0 식만 넣어라.',
    '- 도형/표 템플릿: grid_number_table, tiled_rectangles_layout, regular_polygon_chain, rectangle_side_point_triangle, rectangle_cut_corner, rectangle_expanding_sides, three_semicircles, folded_rectangle_overlap, square_internal_rectangles, regular_polygon_diagonals, annulus_area, circle_with_two_semicircles, rectangle_point_triangle, rectangle_cross_road, rectangle_slanted_cross_road, rectangle_multi_slanted_roads, square_expanded_garden, rectangular_park_border, rectangle_diagonal_flower_path, two_squares_on_segment, two_squares_from_segment, growing_rectangle, open_box_net_equal_cuts, open_box_net_rectangular_paper, folded_tray, adjacent_rectangles, moving_points_rectangle_triangle, right_isosceles_triangle_inner_rectangle, right_isosceles_triangle_parallelogram, tiled_rectangle_corner_square.',
    ...
    '- 전용 템플릿 추가 영어 항목은 rows, cols, entries, cell_width, cell_height, side, sides, count, point_side, point_ratio, triangle_points, top_cut, right_cut, right_expand, bottom_expand, diameter, split, fold_x, inner_x, inner_y, offsets, guide_xs, point_labels, top_width, bottom_width, left_height, right_height, x_labels, y_labels, labels_top, labels_bottom, diagonal, fill, radius, outer_radius, inner_radius, center_gap, square_side, move_time, speed, p_label, q_label, r_label, verticals, horizontals를 허용한다.',
