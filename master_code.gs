...
function buildSimilarProblemsPrompt_(studentName, examName, wrongProblems, reportText, rulesByType, planItems) {
  ...
  return [
    ...
    '- 전용 템플릿 추가 영어 항목은 rows, cols, entries, cell_width, cell_height, side, sides, count, stages, dot_size, point_side, point_ratio, triangle_points, top_cut, right_cut, right_expand, bottom_expand, right_shift, diameter, split, fold_x, inner_x, inner_y, offsets, guide_xs, point_labels, top_width, bottom_width, left_height, right_height, x_labels, y_labels, labels_top, labels_bottom, diagonal, fill, radius, outer_radius, inner_radius, increase, radius_gap, center_gap, square_side, move_time, speed, p_label, q_label, r_label, verticals, horizontals, base, skew, path_width, frame_width, levels, left_side, right_side, depth, cell를 허용한다.',
